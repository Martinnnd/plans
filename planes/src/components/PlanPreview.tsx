...
export default function PlanPreview({ plan }: PlanPreviewProps) {
  return (
    <div className="w-full overflow-hidden rounded-[2.2rem] border border-white/10 bg-white/10 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-2xl">
      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="relative flex flex-col justify-center bg-gradient-to-br from-white/8 via-violet-500/5 to-pink-500/5 p-8">
          ...
          <div className="mt-8 rounded-[1.5rem] border border-white/10 bg-white/8 p-5 text-sm text-white/75">
